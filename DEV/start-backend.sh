...
# Starts the Shaka Security Scanner backend with AWS Bedrock integration

set -e

echo "🚀 Starting Shaka Security Scanner Backend..."
echo ""
...
if [ -f ".env.backend" ]; then
    ...
    echo -e "${YELLOW}⚠ .env.backend not found, using defaults${NC}"
...
# Create backend API server script
